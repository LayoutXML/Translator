...
public class AddFrame extends JFrame {
	...
	public AddFrame(String word, Translator translatorReference, int languageIndexReference, boolean englishOnLeftReference) {
		...
		lblAddingANew.setFont(new Font("Cambria Math", Font.BOLD, 26));
		...
		originalWordInput.setFont(new Font("Cambria Math Semilight", Font.PLAIN, 20));
		...
		translationInput.setFont(new Font("Cambria Math Semilight", Font.PLAIN, 20));
		translationInput.setBounds(333, 198, 244, 176);
		contentPane.add(translationInput);
		
		JButton btnNewButton = new JButton("Add");
		btnNewButton.setFont(new Font("Cambria Math Semilight", Font.PLAIN, 30));
		...
		lblTranslation.setFont(new Font("Cambria Math Semilight", Font.PLAIN, 20));
